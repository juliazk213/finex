          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
              ...
              <div className="flex flex-row items-stretch w-full max-w-lg md:max-w-xl gap-4">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/git-blob/prj_21frYAk7PKWPUKXqvzsGwgLLS80F/cqVWNBNZglh5v4uxkFB9Mc/public/pagina30/Image%202.webp"
                  alt="Man smiling"
                  width={250}
                  height={300}
                ...
                />
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/git-blob/prj_21frYAk7PKWPUKXqvzsGwgLLS80F/v2TFEw_1Dce93all5eiyv2/public/pagina30/SP%20easier%20dark.webp"
                  alt="Daily progress examples"
                  width={300}
                  height={300}
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <Image src="/pagina30/easier_emoji.webp" alt="coin" width={24} height={24} />
                  <span>You can start with $20</span>
                </div>
                <div className="flex items-center gap-3">
                  <Image src="/pagina30/easier_emoji.webp" alt="hat" width={24} height={24} />
                  <span>No need for a Finance degree</span>
                </div>
                <div className="flex items-center gap-3">
                  <Image src="/pagina30/easier_emoji.webp" alt="chart" width={24} height={24} />
                  <span>No need to be a market expert</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-4 max-w-xl mx-auto mb-8">
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div
                    className={`w-6 h-6 rounded-full border-2 ${selectedPlan === "1-week" ? "border-lime-400" : "border-gray-600"} flex items-center justify-center flex-shrink-0`}
                  >
                ...
                <div className="flex flex-col items-end">
                  <div className="flex items-baseline text-white font-bold">
                    ...
                    <span className="text-4xl tracking-tighter pr-0.5">1.</span>
              ...
              >
                ...
                <div className="p-5 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    {/* Círculo de seleção (Radio) */}
                    <div
                      className={`w-6 h-6 rounded-full border-2 ${selectedPlan === "4-week" ? "border-lime-400" : "border-gray-600"} flex items-center justify-center flex-shrink-0`}
                    >
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  {/* Círculo de seleção (Radio) */}
                  <div
                    className={`w-6 h-6 rounded-full border-2 ${selectedPlan === "12-week" ? "border-lime-400" : "border-gray-600"} flex items-center justify-center flex-shrink-0`}
                  >
                ...
                <div className="flex flex-col items-end">
                  <div className="flex items-baseline text-white font-bold">
                    <span className="text-xl">€</span>
                    <span className="text-4xl tracking-tighter pr-0.5">0.</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <div className="bg-[#1C1C1E] rounded-lg p-6">
                ...
                <p className="text-gray-300 text-sm mb-4">
                  "The company excelled by not rushing beginners into trading, instead ensuring that they first receive
                  proper learning and practice."
                </p>
              ...
              <div className="bg-[#1C1C1E] rounded-lg p-6">
                ...
                <p className="text-gray-300 text-sm mb-4">
                  "Initially skeptical, I've been pleasantly surprised by the app's effectiveness. It provides a wealth
                  of insights and helped me to increase my balance saving and investing wisely."
                </p>
                <div className="flex text-yellow-400">★★★★★</div>
              </div>
              <div className="bg-[#1C1C1E] rounded-lg p-6">
                ...
                <p className="text-gray-300 text-sm mb-4">
                  "This app has completely altered my approach to finances. Originally a big spender, I've learned to
                  embrace smarter financial habits. The lessons are straightforward, engaging, and highly applicable."
                </p>
                <div className="flex text-yellow-400">★★★★★</div>
              </div>
            </div>
